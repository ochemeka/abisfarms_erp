...
<div class="mb-5 overflow-x-hidden">
    ...
    <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-3 mb-3">
        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full md:w-auto">
            <select @change="addFromProduct($event)"
                class="w-full sm:w-72 px-3 py-2 border border-gray-200
                       dark:border-gray-600 dark:bg-gray-700
            ...
            <button type="button"
                    @click="addItem()"
                    class="text-xs px-4 py-2 border
                           border-bh-red text-bh-red rounded-lg
                           hover:bg-bh-light transition-colors whitespace-nowrap">
                + Add Item
            </button>
        </div>
    </div>
    ...
    {{-- Desktop header --}}
    <div class="hidden lg:grid grid-cols-12 gap-3 px-3 py-2
    ...
    <template x-for="(item, index) in items" :key="index">
        ...
        <div class="border border-gray-200 dark:border-gray-700
                    rounded-xl p-3 mb-3 lg:border-0 lg:p-0">

            <div class="grid grid-cols-1 lg:grid-cols-12 gap-3 items-start">

                {{-- Description --}}
                <div class="lg:col-span-4">
                    <label class="lg:hidden text-xs text-gray-500 mb-1 block">
                        Description
                    </label>
                ...
                {{-- Total --}}
                <div class="lg:col-span-1 flex lg:justify-end items-center">
...
{{-- Totals summary --}}
<div class="w-full md:ml-auto md:max-w-sm
    ...
    <div class="space-y-3 text-sm">
        ...
        <div class="flex justify-between items-center gap-4">
            ...
            <input type="number"
                   ...
                   min="0"
                   placeholder="0.00"
                   class="w-28 sm:w-32 text-right px-2 py-1 border
        ...
        <div class="flex justify-between items-start gap-4
                    ...
                    dark:border-gray-700 pt-3">

            <span class="text-gray-800 dark:text-white">
                Total
            </span>

            <span class="text-bh-red text-right break-all text-lg">
                <span
