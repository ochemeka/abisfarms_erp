...
<div class="flex flex-col h-screen">
    ...
    <div class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-2 flex items-center justify-between flex-shrink-0">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('pos.dashboard') }}" class="text-xs px-3 py-1.5 border border-gray-200 dark:border-gray-600 rounded-lg text-gray-500 hover:border-bh-red hover:text-bh-red transition-colors">
                Dashboard
            </a>
        </div>
    </div>
        ...
        <div class="p-5">
            ...
            <div class="space-y-2">
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <a :href="'/pos/receipt/' + lastSale.sale_id" target="_blank"
